        ...
        try:
            response = client.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": f"Summarize this event in {preferences['summary_length']} words, emphasizing key points:\n\n{article} . Do not include any links or references to external sources. Do not say anything that is not in the article. Generate your summary using only information that can be attributed to the article."}
                ],
                temperature=0.5,
